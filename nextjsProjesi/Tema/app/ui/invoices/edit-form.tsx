        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              id="customer"
              name="customerId"
              className="text-gray-600 peer block w-full cursor-pointer rounded-md border py-2 pl-10 text-sm outline-2"
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                className="text-gray-600 peer block w-full rounded-md border py-2 pl-10 text-sm outline-2"
                required
              />
